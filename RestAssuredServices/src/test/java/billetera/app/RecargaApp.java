...
import dto.app.recarga.DatosEntrada;
import dto.app.recarga.LstProductoRecarga;
import dto.app.recarga.RecargaINDto;
...
public class RecargaApp {
    ...
    public RecargaINDto initValue(){

        RecargaINDto transaccion = new RecargaINDto();

        DatosEntrada datosEntrada = new DatosEntrada();

        ArrayList<LstProductoRecarga> lstProductoRecargas = new ArrayList<>();

        LstProductoRecarga recarga = new LstProductoRecarga();

        recarga.setCodigoOperador("1");
        recarga.setNumeroCelular("3006593822");
        recarga.setCodOperadorPaquete("");
        recarga.setCodPaquete("");
        recarga.setValorUnitario(5000);
        recarga.setCantidad(1);
        recarga.setValorProducto(5000);
        recarga.setValorDescuento(0);
        recarga.setValorIva(0);
        recarga.setTipoTarifaTransaccion(idTipoTarifaTransaccion);
        recarga.setValorTransaccion(0);
        recarga.setValorPagar(5000);
        recarga.setCantidadPuntos(10);
        recarga.setIdProductoTrans(0);

        lstProductoRecargas.add(recarga);

        datosEntrada.setLstProductoRecarga(lstProductoRecargas);
    ...
    @Test
    public void RecargaSuccessful() {


        RecargaINDto transaccion = initValue();
