...
import dto.app.combomillonario.ComboMillonarioINDto;
import dto.app.combomillonario.DatosEntrada;
import dto.app.combomillonario.ProductoComboMillonario;
...
public class ComboMillonarioApp {
    ...
    public ComboMillonarioINDto initValue(){

        ComboMillonarioINDto transaccion = new ComboMillonarioINDto();

        DatosEntrada datosEntrada = new DatosEntrada();

        ArrayList<ProductoComboMillonario> listComboMillonarios = new ArrayList<>();

        ProductoComboMillonario comboMillonario = new ProductoComboMillonario();

        comboMillonario.setCantidad(1);
        comboMillonario.setValorIva(1756);
        comboMillonario.setValorPagar(11000);
        comboMillonario.setFechaSorteo(fechaActual());
        comboMillonario.setValorProducto(11000);
        comboMillonario.setValorUnitario(11000);
        comboMillonario.setCantidadPuntos(0);
        comboMillonario.setValorDescuento(0);
        comboMillonario.setIdProductoTrans(0);
        comboMillonario.setValorTransaccion(0);
        comboMillonario.setCodigoModalidad("1");
        comboMillonario.setTipoTarifaTransaccion(idTipoTarifaTransaccion);
        ...
        comboMillonario.setNumeros(numeros);
        ...
        comboMillonario.setLoterias(listLotieria);
    ...
    @Test
    public void ComboMillonarioSuccessful() {


        ComboMillonarioINDto transaccion = initValue();
